...
void* IProductA_Wrapper::cast2Base(const string basename)
{
...
void* IProductB_Wrapper::cast2Base(const string basename)
{
...
void* IProductC_Wrapper::cast2Base(const string basename)
{
