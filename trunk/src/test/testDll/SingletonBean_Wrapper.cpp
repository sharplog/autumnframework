...
#include "SingletonBean_Wrapper.h"

/**
 * Wrapper methods for SingletonBean
 */
...
int SingletonBean_Wrapper::execVoidMethod(string& method, void** Prams, int num)
{
	if( !method.compare("setString") && num == 1 )
...
int SingletonBean_Wrapper::getParamTypes(string& method, string& types, int num)
{
	if( !method.compare("setString") && num == 1 )
		types = string("")
			  + "string|";
		...
		types = string("");
	else if( !method.compare("SingletonBean") && num == 0 )
		types = string("");
	else 
		return -1;
...
AUTUMN_SingletonBean_Wrapper_Local _AUTUMN_SingletonBean_Wrapper_Local_;
